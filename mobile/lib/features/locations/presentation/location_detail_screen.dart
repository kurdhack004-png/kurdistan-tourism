          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Container(
                color: AppColors.clay, // placeholder until media.url() photos are wired in
                child: Center(
                  child: Icon(Icons.landscape_rounded,
                      size: 64, color: AppColors.limestoneWhite.withOpacity(0.5)),
                ),
              ),
            ),
          ),
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(location.nameCkb, style: Theme.of(context).textTheme.displayLarge),
                      ),
                      GestureDetector(
                        ...
                        child: const RatingBadge(rating: 4.8), // wire to a real average once reviews accumulate
                      ),
                    ],
                  ),
                  ...
                  Row(
                    children: [
                      const Icon(Icons.terrain_rounded, size: 15, color: AppColors.riverstone),
                    ...
                    children: [
                      Expanded(
                        child: OutlinedButton.icon(
                          ...
                          icon: Icon(inTrip ? Icons.playlist_add_check_rounded : Icons.playlist_add_rounded, size: 18),
                          label: Text(inTrip ? 'لە پلانی گەشتدایە' : 'زیادکردن بۆ پلانی گەشتم'),
                        ),
                      ),
                  ...
                  SizedBox(
                    ...
                    child: FilledButton.icon(
                      onPressed: () => Navigator.of(context).push(MaterialPageRoute(
                        builder: (_) => NearbyStaysScreen(lat: location.latitude, lng: location.longitude),
                      )),
