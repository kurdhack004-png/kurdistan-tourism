        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _DarkField(controller: _emailCtrl, hint: 'ئیمەیل', keyboardType: TextInputType.emailAddress),
              const SizedBox(height: AppSpacing.md),
              ...
              if (auth.error != null)
                Padding(
                  ...
                  child: Text(auth.error!, style: const TextStyle(color: Color(0xFFE38E7E), fontSize: 13)),
                ),
              FilledButton(
              ...
              TextButton(
                ...
                child: const Text('هەژمارت نییە؟ خۆت تۆمار بکە',
...
class _DarkField extends StatelessWidget {
  const _DarkField({required this.controller, required this.hint, this.obscure = false, this.keyboardType});
